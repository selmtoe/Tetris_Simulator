...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('tetris_recovery.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('tetris_recovery.wasm', import.meta.url).href;
...
var _tr_board_finish = Module['_tr_board_finish'] = makeInvalidEarlyAccess('_tr_board_finish');
var _tr_recover = Module['_tr_recover'] = makeInvalidEarlyAccess('_tr_recover');
var _tr_sample_interval = Module['_tr_sample_interval'] = makeInvalidEarlyAccess('_tr_sample_interval');
var _tr_onnx_samples = Module['_tr_onnx_samples'] = makeInvalidEarlyAccess('_tr_onnx_samples');
var _tr_write_output = Module['_tr_write_output'] = makeInvalidEarlyAccess('_tr_write_output');
var _tr_output_path = Module['_tr_output_path'] = makeInvalidEarlyAccess('_tr_output_path');
var _tr_output_url = Module['_tr_output_url'] = makeInvalidEarlyAccess('_tr_output_url');
var _tr_copy_error = Module['_tr_copy_error'] = makeInvalidEarlyAccess('_tr_copy_error');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['tr_board_finish'] != 'undefined', 'missing Wasm export: tr_board_finish');
  assert(typeof wasmExports['tr_recover'] != 'undefined', 'missing Wasm export: tr_recover');
  assert(typeof wasmExports['tr_sample_interval'] != 'undefined', 'missing Wasm export: tr_sample_interval');
  assert(typeof wasmExports['tr_onnx_samples'] != 'undefined', 'missing Wasm export: tr_onnx_samples');
  assert(typeof wasmExports['tr_write_output'] != 'undefined', 'missing Wasm export: tr_write_output');
  assert(typeof wasmExports['tr_output_path'] != 'undefined', 'missing Wasm export: tr_output_path');
  assert(typeof wasmExports['tr_output_url'] != 'undefined', 'missing Wasm export: tr_output_url');
  assert(typeof wasmExports['tr_copy_error'] != 'undefined', 'missing Wasm export: tr_copy_error');
  ...
  _tr_board_finish = Module['_tr_board_finish'] = createExportWrapper('tr_board_finish', wasmExports['tr_board_finish'], 6);
  _tr_recover = Module['_tr_recover'] = createExportWrapper('tr_recover', wasmExports['tr_recover'], 0);
  _tr_sample_interval = Module['_tr_sample_interval'] = createExportWrapper('tr_sample_interval', wasmExports['tr_sample_interval'], 0);
  _tr_onnx_samples = Module['_tr_onnx_samples'] = createExportWrapper('tr_onnx_samples', wasmExports['tr_onnx_samples'], 0);
  _tr_write_output = Module['_tr_write_output'] = createExportWrapper('tr_write_output', wasmExports['tr_write_output'], 2);
  _tr_output_path = Module['_tr_output_path'] = createExportWrapper('tr_output_path', wasmExports['tr_output_path'], 1);
  _tr_output_url = Module['_tr_output_url'] = createExportWrapper('tr_output_url', wasmExports['tr_output_url'], 1);
  _tr_copy_error = Module['_tr_copy_error'] = createExportWrapper('tr_copy_error', wasmExports['tr_copy_error'], 2);
