...
impl<E: Evaluator> BotState<E> {
    ...
    /// Number of nodes currently retained by the reference DAG.
    ///
    /// This is exposed only for the simulator's benchmark/debug bridge; it
    /// does not affect search or evaluation.
